...
function initDatabase() {
  db.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_daily_stats_monitor
    ON daily_stats(monitor_id);
...
function saveDailyStats({
  ...
  db.prepare(`
    ...
    DO UPDATE SET
      ...
      matched_comments =
        excluded.matched_comments,

      unmatched_comments =
        excluded.unmatched_comments,
