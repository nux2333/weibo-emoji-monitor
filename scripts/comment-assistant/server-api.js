...
app.post('/api/my-tasks/:account/confirm-next', userAuth, (req, res) => {
  try {
    ...
    const current = db.prepare(`SELECT a.task_id, t.post_id, t.post_link
